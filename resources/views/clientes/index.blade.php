...
<div class="container-fluid bg-light p-4">
    ...
    <div class="card shadow-lg rounded p-4" style="background-color: #d2b48c;">
        ...
        <div class="text-end mb-3">
            <a href="{{ route('clientes.create') }}" class="btn btn-success shadow">
            ...
            <table class="table table-hover table-bordered shadow-sm">
                ...
                <tbody>
                    ...
                    <tr class="text-center">
                        ...
                        <td>
                            <a href="{{ url('clientes/' . $cliente->id_cliente . '/edit') }}" class="btn btn-warning btn-sm shadow">
                                <i class="fa-solid fa-edit"></i> Editar
                            </a>

                            <form action="{{ url('clientes/' . $cliente->id_cliente) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
