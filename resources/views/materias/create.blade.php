...
<div class="container-fluid bg-light p-4">
    ...
    <div class="row" style="height: 100vh;">
        ...
        <!-- Contenido principal (Formulario de creación de materia) -->
        <div class="col-10 p-4">
            <div class="card shadow-lg rounded p-4" style="background-color: #d2b48c;">
                <h1 class="bg-primary text-white p-4 rounded-top text-center" style="font-family: 'Fenix', serif; font-size: 2.5rem;">Crear Nueva Materia</h1>
