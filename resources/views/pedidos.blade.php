...
<div class="container-fluid bg-light">
    <div class="row" style="height: 100vh;">
        ...
        <div class="col-2 bg-primary p-4 text-light rounded-start shadow-lg h-100">
            ...
            <h5 class="p-2"><a href="{{url('chocotopia')}}" class=" btn text-decoration-none {{request()->routeIs('chocotopia')?'active_custom':''}} text-white"><i class="fa-solid fa-box"></i> Regresar
                    </a></h5>
            </div>
        ...
        <div class="col-7 p-5">
            ...
            <h3 class="bg-primary text-white p-3 rounded-top">Pedidos registrados</h3>
