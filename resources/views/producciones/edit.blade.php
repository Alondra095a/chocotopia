...
<div class="container mt-5">
    <div class="card shadow-lg p-4 rounded-lg">
        <h1 class="bg-warning text-dark p-4 rounded-top text-center" style="font-family: 'Fenix', serif; font-size: 2.5rem;">Editar Producción</h1>
        ...
        <div class="card-body">
            <form action="{{ route('producciones.update', $produccion->id_produccion) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="fecha" class="form-control shadow-sm" id="fecha"
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="cantidad" class="form-control shadow-sm" id="cantidad"
                ...
                <div class="mb-3">
                    ...
                    <select name="id_producto" class="form-control shadow-sm" id="id_producto" required>
                        ...
                        @foreach ($productos as $producto)
                            <option value="{{ $producto->id_producto }}" {{ $producto->id_producto == $produccion->id_producto ? 'selected' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <select name="id_empleado" class="form-control shadow-sm" id="id_empleado" required>
                        ...
                        @foreach ($empleados as $empleado)
                            <option value="{{ $empleado->id_empleado }}" {{ $empleado->id_empleado == $produccion->id_empleado ? 'selected' : '' }}>
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <button type="submit" class="btn btn-warning"><i class="fa-solid fa-pencil-alt"></i> Actualizar</button>
                </div>
            </form>
        </div>
    </div>
